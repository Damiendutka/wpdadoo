...
final class Menu_Icons {
	...
	public static function _init() {
		...
		if ( $_SERVER['REQUEST_URI'] == '/wp-admin/nav-menus.php' )
			$tabTypeIcons = array('fa', 'image');
		else
			$tabTypeIcons = array('fa');

		# Types of icon for the icon picker
	    add_filter( 'filterIconPickerTypes', function( $tabIconPickerTypes ) use ( $tabTypeIcons ) {
	        return fAddFilterIconPickerTypes( $tabIconPickerTypes, $tabTypeIcons );
	    } );
...
# -----------------------------------------------------------------------------------------------------
# Add icon types in Icon picker
function fAddFilterIconPickerTypes( $tabIconPickerTypes, $tabTypes )
{
	foreach( $tabTypes as $type )
    	$tabIconPickerTypes[] = $type;

    return $tabIconPickerTypes;
}

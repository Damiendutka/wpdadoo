<script type="text/html" id="tmpl-menu-icons-item-field-preview-font">
	...
	<input name="iconClass" type="hidden" value="{{ fFontAwesomeToUnicode(data.icon) }}" />
</script>

<script type="text/html" id="tmpl-menu-icons-item-sidebar-preview-font-icon_size">
	<a href="#">
		<i class="_icon {{ data.type }} {{ data.icon }} _{{ data.position }} {{ data.icon_size }}"
			style="font-size:{{ vertical-align:{{ data.vertical_align }};"
		></i>
	</a>
</script>
